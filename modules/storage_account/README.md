...
| <a name="input_min_tls_version"></a> [min\_tls\_version](#input\_min\_tls\_version) | (Optional) The minimum supported TLS version for the storage account. As of azurerm 5.0 only TLS1\_2 is supported. | `string` | `"TLS1_2"` | no |
