...
| <a name="input_rbac_authorization_enabled"></a> [rbac\_authorization\_enabled](#input\_rbac\_authorization\_enabled) | (Optional) Whether Azure Key Vault uses Role Based Access Control (RBAC) for authorization of data actions. Required as of azurerm 5.0. | `bool` | `false` | no |
