...
| <a name="input_max_capacity"></a> [max\_capacity](#input\_max\_capacity) | (Optional) The maximum number of instances to use when autoscaling. | `number` | `2` | no |
| <a name="input_min_capacity"></a> [min\_capacity](#input\_min\_capacity) | (Optional) The minimum number of instances to use when autoscaling. | `number` | `0` | no |
